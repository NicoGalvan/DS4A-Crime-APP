...
layout = html.Div([
    ...
    html.Img(src=app.get_asset_url('imagenes/banner1-4.jpg'),width='90%', style={'display':'block','margin':'auto','height':'auto'} ),
    ...
    html.Iframe(src='https://www.youtube.com/embed/An6cWheNYtc',width='66%',height='auto',title="YouTube video player",allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture",className='vidMain', style={'display':'block','margin':'auto'} ),
    ...
    html.Br(),
    html.P(['- National Census of population and Household 2018-DANE-Geostatistical National Framework',html.Br(),
    html.Div([
    html.A('https://geoportal.dane.gov.co/servicios/descarga-y-metadatos/visor-descarga-geovisores/',href='https://geoportal.dane.gov.co/servicios/descarga-y-metadatos/visor-descarga-geovisores/')]),
    ], style={'wordBreak':'break-all'}),
    ...
    html.Div([
        html.Img(src=app.get_asset_url('imagenes/Footer/image 15.png'),className='imgsFooter'),
        html.Img(src=app.get_asset_url('imagenes/Footer/image 17.png'),className='imgsFooter'),
        html.Img(src=app.get_asset_url('imagenes/Footer/image 16.png'),className='imgsFooter'),
        
    ],className='BloqFooter', style={    'height': '90px','paddingTop':'40px','width':'100%'})
